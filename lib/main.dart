    ...
    if (isConnected) {
      try {
        ...
        if (!kIsWeb) {
          ...
          SupabaseService.setInitialized(true);
          debugPrint('Supabase initialized successfully');
        } else {
          debugPrint(
              'Web environment detected, skipping Supabase initialization');
          // For web, we could initialize a mock or alternative implementation
          // For now, we'll just set the flag to false to indicate it's not initialized
          SupabaseService.setInitialized(false);
        }
      } catch (e, stackTrace) {
