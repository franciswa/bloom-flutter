...
class QuestionnaireProvider extends ChangeNotifier {
  ...
  Future<void> _loadUserAnswers() async {
    ...
    _userAnswers = await ServiceRegistry.questionnaireService.getUserAnswers(userId);
  }
  ...
  List<QuestionnaireQuestion> getQuestionsByCategory(QuestionnaireCategory category) {
  ...
  double getCompletionPercentageByCategory(QuestionnaireCategory category) {
    ...
    final categoryAnswers = _userAnswers.where((a) => 
  ...
  Future<void> saveAnswer({
    ...
    try {
      ...
      final savedAnswer = await ServiceRegistry.questionnaireService.saveUserAnswer(
        userId: userId,
  ...
  Future<void> deleteAnswer(String questionId) async {
    ...
    try {
      ...
      await ServiceRegistry.questionnaireService.deleteUserAnswer(userId, questionId);
  ...
  Future<QuestionnaireResult> calculateCompatibilityWithUser(String otherUserId) async {
    if (_authProvider.currentUser == null) {
    ...
    try {
      ...
      final result = await ServiceRegistry.questionnaireService.calculateQuestionnaireCompatibility(
        userId,
        otherUserId,
      );
  ...
  Future<QuestionnaireResult?> getCompatibilityResultWithUser(String otherUserId) async {
    if (_authProvider.currentUser == null) {
      return null;
    }
    ...
    try {
      ...
      final result = await ServiceRegistry.questionnaireService.getQuestionnaireResult(
        userId,
        otherUserId,
      );
  ...
  Future<void> submitCompatibilityQuestionnaire(Map<String, int> questionAnswers) async {
    if (_authProvider.currentUser == null) {
      throw Exception('User not authenticated');
    }
